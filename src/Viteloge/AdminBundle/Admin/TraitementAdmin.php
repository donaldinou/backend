...
{    
    ...
    {
        $formMapper
            ->with( $this->trans( 'group.traitement.general' ) )
            ...
            ->end()
            ->with( $this->trans( 'group.traitement.expr_detail' ) )
              ->add( 'ExpNbBien', 'text', array( 'required' => false ) )
              ->add( 'ExpNbPage', 'text', array( 'required' => false ) )
            ->end()
            ->with( $this->trans( 'group.traitement.next_page' ) )
              ->add( 'ExpPageSuivante', 'text', array( 'required' => false ) )
            ->add( 'ModelUrlPageSuivante', 'text', array( 'required' => false ) )
            ->end()
            ->with( $this->trans( 'group.traitement.prop_link' ) )
              ...
              ->add( 'SplitResultAnnonce', 'text', array( 'required' => false, 'help' => $this->trans( "help.split_result_annonce" ) ) )
              ->add( 'ExpUrlElements', 'text', array( 'required' => false, 'help' => $this->trans( "help.exp_url_elements" ) ) )
              ->add( 'ModelUrlFicheFinal', null, array( 'required' => false ) )
            ->end()
            ->with( $this->trans( 'group.traitement.modules' ) )
            ...
            ->end()
            ->with( $this->trans( 'group.traitement.prop_photo' ) )
            ...
            ->end()
            ->with( $this->trans( 'group.traitement.prop_info' ) )
